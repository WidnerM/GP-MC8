...
#define MCPRO_COLOR_PAYLOAD "55 55 55 55 01 02 03 04 05 06 07 08 09" // last nine are 3 LED colors, 3 text colors, 3 background colors
#define MCPRO_POS_COLOR_LEDS 20
#define MCPRO_POS_COLOR_TEXT 23
#define MCPRO_POS_COLOR_BACK 26
...
#define MC8PRO_COLOR_PRESET 23
#define MC8PRO_LONGNAME_PRESET 22
...
#define MC6PRO_COLOR_PRESET 23
#define MC6PRO_LONGNAME_PRESET 22

#define MC4PRO_PREFIX "f0 00 21 24 09 00 70 00 00 00 00 00 00 00 00 00"
#define MC4PRO_ROWLEN 2
#define MC4PRO_SHORTLEN 32
#define MC4PRO_LONGLEN 32
#define MC4PRO_COLOR true
#define MC4PRO_COLOR_PRESET 14
#define MC4PRO_LONGNAME_PRESET 13
...
#define MCX_MIDI_IN "^MIDIIN2.*MC8 Pro.*", "MIDIIN2 (Morningstar MC8)", "MIDIIN2 (Morningstar MC6 Pro)", "MIDIIN2 (Morningstar MC4 Pro)","MIDIIN2 (Morningstar MC6)", ".*MC4 Pro Port 2.*", ".*MC6 Pro Port 2.*", ".*MC8 Pro Port 2.*"
#define MIDI_IN_WIDGETNAME "mcx_midiin"
#define MCX_MIDI_OUT "^MIDIOUT2.*MC8 Pro.*", "MIDIOUT2 (Morningstar MC8)", "MIDIOUT2 (Morningstar MC6 Pro)", "MIDIOUT2 (Morningstar MC4 Pro)","MIDIOUT2 (Morningstar MC6)", ".*MC4 Pro Port 2.*", ".*MC6 Pro Port 2.*", ".*MC8 Pro Port 2.*"
